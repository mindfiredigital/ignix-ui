...
const PricingGridContent = ({
  ...
  description = "Choose the plan that fits your needs and plans",
  plans,
  className,
  variant = "dark",
  pricingBadgePosition = "middle",
    ...
    <div className="w-full px-4 py-10">
      ...
      >
        ...
        >
          ...
          {/* Toggle */}
          <div className="mb-6 flex items-center justify-center gap-3 text-md font-medium text-white">
            <span>Paid</span>
            <Switch 
              checked={isFree}
...
export const PricingGrid = (props: any) => {
