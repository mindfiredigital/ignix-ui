...
:root {
  ...
  --destructive-dark: hsl(0 73.7% 41.8%);
  --success: var(--ignix-success, hsl(160.1 84.1% 39.4%));
  --success-foreground: var(--ignix-text, hsl(222.2 47.4% 11.2%));
  --success-light: hsl(158.1 64.4% 51.6%);
  --success-dark: hsl(162.9 93.5% 24.3%);
  --warning: var(--ignix-warning, hsl(37.7 92.1% 50.2%));
  --warning-foreground: var(--ignix-text, hsl(222.2 47.4% 11.2%));
  --warning-light: hsl(43.3 96.4% 56.3%);
  --warning-dark: hsl(26 90.5% 37.1%);
  --purple: var(--ignix-purple, hsl(271.5 81.3% 55.9%));
  --purple-foreground: var(--ignix-text-inverse, hsl(210 40% 98%));
  --info: var(--ignix-info, hsl(188.7 94.5% 42.7%));
  --info-foreground: var(--ignix-text-inverse, hsl(210 40% 98%));
  --info-light: hsl(187.9 85.7% 53.3%);
  --info-dark: hsl(192.9 82.3% 31%);
