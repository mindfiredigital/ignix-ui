...
<Tabs defaultValue="preview">
  ...
  <TabItem value="code" label="Code">
    ```tsx
    import { AppShell } from '@mindfiredigital/ignix-ui';
...
```tsx
<AppShell theme="modern" ... />
<AppShell theme="dark" ... />
<AppShell theme="light" ... />
<AppShell theme="corporate" ... />
<AppShell theme="ocean" ... />
<AppShell theme="forest" ... />
<AppShell theme="solarized" ... />
...
| `theme` | `"light" \| "dark" \| "corporate" \| "ocean" \| "forest" \| "solarized" \| "modern"` | `"dark"` | Built-in theme options |
