...
## Use Cases
- 👉 **Button toolbars** – Arrange a group of actions (e.g., Save, Edit, Delete) in a consistent horizontal stack.
- 👉 **Form layouts** – Stack input fields, labels, and buttons vertically with proper spacing for better readability.
- 👉 **Navigation menus** – Create a row of links for desktop and stack them vertically on mobile for responsive design.
- 👉 **Card grids** – Use wrapping stacks to arrange cards in different screen sizes while keeping equal spacing.