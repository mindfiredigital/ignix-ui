...
import { StatsGrid, StatsGridTitle, StatsGridDescription, StatsGridCard, StatsGridContainer } from '@ignix-ui/stats-grid';
...
const StatsGridExample = () => {
  ...
  return (
    <StatsGrid
      ...
      padding="lg"
    >
      <StatsGridTitle>Simple Stats Grid Demo</StatsGridTitle>
