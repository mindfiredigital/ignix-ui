...
| `accentColor` | `string` | `"text-purple-600"` | Tailwind class for title highlight and toggle accent. |
| `toggleActiveColor` | `string` | `"bg-purple-600"` | Tailwind class for active toggle button. |
| `titleColor` | `string` | `"text-gray-900"` | Tailwind class for main title. |
| `descriptionColor` | `string` | `"text-gray-600"` | Tailwind class for description text. |
| `labelColor` | `string` | `"text-gray-500"` | Tailwind class for "PRICING" label. |
| `sectionBackgroundColor` | `string` | `"bg-white"` | Tailwind class or CSS color for section background. |
| `sectionBackgroundImage` | `string` | — | URL string for section background image. |
| `sectionBackgroundOverlay` | `string` | — | Tailwind class for overlay on section background image. |
...
| `cardColor` | `string` | — | Color name (e.g., 'blue', 'purple', 'green') - automatically generates borderColor, buttonColor, buttonTextColor, badgeColor. |
| `borderColor` | `string` | — | Tailwind class for border (e.g., 'border-purple-200/60') - overrides cardColor. |
| `buttonColor` | `string` | — | Tailwind classes for button (e.g., 'bg-purple-600 hover:bg-purple-700') - overrides cardColor. |
| `buttonTextColor` | `string` | — | Tailwind class for button text (e.g., 'text-white') - overrides cardColor. |
| `badgeColor` | `string` | — | Tailwind classes for badge (e.g., 'bg-purple-600 text-white') - overrides cardColor. |
| `cardBackgroundColor` | `string` | — | Tailwind class or CSS color for card background (e.g., 'bg-white', 'bg-gray-50'). |
| `cardBackgroundImage` | `string` | — | URL string for card background image. |
| `cardBackgroundOverlay` | `string` | — | Tailwind class for overlay on card background image (e.g., 'bg-black/50'). |
---
