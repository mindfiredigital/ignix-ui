...
import { GradientOverlayBackgroundDemo, CenteredWithBackgroundImageDemo, SplitLayoutDemo } from '@site/src/components/Demo/CallToActionDemo';
...
<GradientOverlayBackgroundDemo />

## Advanced Layout Demo

<CenteredWithBackgroundImageDemo />
