...
// const AccordionItem = ({ id, children, className, disabled = false }: AccordionItemProps) => {
//   const context = useAccordionContext();
//   const isOpen = context.openItems.includes(id);

//   // Theme-aware background colors for item variants
//   const itemThemeClasses = cn({
//     // Default variant - theme aware borders
//     'border-gray-200 dark:border-gray-800': context.theme === 'light' || context.isDark,
//     'border-[#1F2A3F]': context.theme === 'midnight',
//     'border-[#2D353F]': context.theme === 'charcoal',
//     'border-[#1C314F]': context.theme === 'ocean',
//     'border-[#1E3A2A]': context.theme === 'forest',
//     'border-[#3A2A3A]': context.theme === 'sunset',

//     // Card variant - theme aware backgrounds
//     'bg-white': context.theme === 'light' && context.variant === 'card',
//     'bg-gray-900': context.theme === 'dark' && context.variant === 'card',
//     'bg-[#0F1524]': context.theme === 'midnight' && context.variant === 'card',
//     'bg-[#1E242B]': context.theme === 'charcoal' && context.variant === 'card',
//     'bg-[#0A1A2F]': context.theme === 'ocean' && context.variant === 'card',
//     'bg-[#0C231E]': context.theme === 'forest' && context.variant === 'card',
//     'bg-[#201524]': context.theme === 'sunset' && context.variant === 'card',

//     // Bordered variant - theme aware borders
//     'border-gray-200': context.theme === 'light' && context.variant === 'bordered',
//     'border-gray-800': context.theme === 'dark' && context.variant === 'bordered',
//     'border-[#1F2A3F]': context.theme === 'midnight' && context.variant === 'bordered',
//     'border-[#2D353F]': context.theme === 'charcoal' && context.variant === 'bordered',
//     'border-[#1C314F]': context.theme === 'ocean' && context.variant === 'bordered',
//     'border-[#1E3A2A]': context.theme === 'forest' && context.variant === 'bordered',
//     'border-[#3A2A3A]': context.theme === 'sunset' && context.variant === 'bordered',
//   });
...
//   description?: string;
//   icon?: React.ReactNode;
//   layoutVariant?: 'standard' | 'split-left' | 'split-right' | 'grid' | 'minimal-list' | 'contact-sidebar' | 'category-tabs' | 'featured';
...
const FAQSection = ({
    ...
    //     if (item) {
    //       onItemToggle?.(item, newOpenItems.includes(id));
    //     }
