...
| `inputVariant` |	"`clean" \| "borderGlow" \| "glassmorphism" \| "shimmer" \| "borderBeam"` |	`'clean'` |	Visual variant for input fields (clean, borderGlow, glassmorphism, shimmer, borderBeam)
| `buttonVariant` |	"`default" \| "primary" \| "secondary" \| "ghost"` |	`'default'` |	Visual variant for navigation buttons
| `buttonAnimationVariant` |	"`scaleHeartBeat" \| "press3DSoft" \| "spinSlow"` |	`-` |	Animation variant for buttons (scaleHeartBeat, press3DSoft, spinSlow, etc.)
...
| `showStepIndicator` |	`boolean` |	`true` |	Whether to show the step progress indicator
...
| Prop | Type | Default | Description |
|------|------|---------|-------------|
| `title` |	`string` |	`'Multi-Step Form'` |	Title displayed in the header
