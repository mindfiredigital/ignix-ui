...
import { ProfileCardBasicDemo, ProfileCardAdvancedDemo, ProfileCardExamplesDemo} from '@site/src/components/Demo/UserCardDemo';
...
<ProfileCardBasicDemo />

<ProfileCardAdvancedDemo/> 
<ProfileCardExamplesDemo />
