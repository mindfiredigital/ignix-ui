---
sidebar_position: 13
title: AIConversationHistory
description: A sidebar session history component that displays conversation history lists, search controls, and inline rename/delete capabilities.
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';
import { AIConversationHistory } from '@site/src/components/UI/ai-conversation-history';
import AIConversationHistoryDemo from '@site/src/components/Demo/AIConversationHistoryDemo';
...
export interface AIConversationHistoryProps extends VariantProps<typeof sidebarVariants> {
  ...
  /** Callback fired when a session is renamed */
  onSessionRename?: (sessionId: string, newTitle: string) => void;
  /** Callback fired when a session is deleted */
  onSessionDelete?: (sessionId: string) => void;
  /** Callback fired when the 'New Chat' button is clicked */
  onNewChat?: () => void;
  /** Search query value for controlled filtering */
  searchQuery: string;
  /** Callback fired when search input changes */
  onSearchChange: (query: string) => void;
  /** Custom action buttons or subtext footer slot */
  footerSlot?: React.ReactNode;
  /** Custom title label at the top. Defaults to "History" */
  title?: string;
  /** Extra class names */
  className?: string;
}
...
| :--- | :--- | :--- | :--- |
| `sessions` | `ConversationSession[]` | `[]` | List of historical sessions. Each session contains `id`, `title`, `timestamp` (Date/string), and `summary`. |
| `activeSessionId` | `string` | -| Highlights the session item corresponding to the active ID. |
| `searchQuery` | `string` | -| The search/filter value. |
...
| `title` | `string` | `'History'` | Title label rendered in the header. |
| `footerSlot` | `ReactNode` | -| Placed component footer at the bottom of the sidebar. |
