...
export interface AnimatedTextareaProps extends Omit<React.TextareaHTMLAttributes<HTMLTextAreaElement>, "size" | "onChange" | "value" | "onDrag" | "onDragStart" | "onDragEnd" | "onAnimationStart"> {
  id?: string;
  className?: string;
  placeholder?: string;
  variant?: string;
