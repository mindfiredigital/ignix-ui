...
import { FullHeightSidebarLayout } from '../UI/fullheightsidebar-layout';
...
React.useEffect(() => {
  ...
  const mainContent = (
    ...
    <div className={cn("min-h-screen px-6 py-8 transition-all",
      ...
      {/* GLASS STATS */}
      <div className="grid grid-cols-1 md:grid-cols-2  gap-6 mb-10 text-slate-800">
        {[
      ...
      <div className="grid md:grid-cols-1 gap-6">
        ...
        {/* PROJECT STATUS */}
        <div className="md:col-span-2 p-6 rounded-2xl bg-white border border-indigo-100 shadow-xl hover:shadow-2xl transition text-slate-800">
        ...
        {/* TEAM CARD */}
        <div className="text-slate-900 p-6 rounded-2xl bg-white border border-indigo-100 shadow-xl hover:shadow-2xl transition">
      ...
      {/* BOTTOM SECTION */}
      <div className="mt-10 grid md:grid-cols-2 gap-6 text-slate-900">
        ...
        <TabItem value="preview" label="Preview">
          <div className="border rounded-lg overflow-hidden">
            <FullHeightSidebarLayout
              ...
              sidebarPosition={position as any}
              variant={variant as any}
