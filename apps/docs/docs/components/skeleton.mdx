    ...
    (
        ...
        const themeClasses = {
            ...
            primary: isAnimatedGradient
                ? "bg-gradient-to-r from-red-50 via-red-100 to-red-50 dark:from-red-950/40 dark:via-red-900/30 dark:to-red-950/40"
...
| `width` | `string \| number` | - | Width of the component (e.g. `200`, `'100%'`, `'w-16'`) |
| `height` | `string \| number` | - | Height of the component (e.g. `16`, `'20px'`, `'h-16'`) |
