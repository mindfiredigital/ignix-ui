---
sidebar_position: 11
title: AISuggestedActions
description: An interactive suggestions starter template component supporting inline chips, grid cards, and staggered load micro-animations.
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';
import { AISuggestedActions } from '@site/src/components/UI/ai-suggested-actions';
import AISuggestedActionsDemo from '@site/src/components/Demo/AISuggestedActionsDemo';
            ...
            >
              <Button
                ...
                className={cn(
                  ...
                  variant === "glass" && "bg-white/10 border-white/20 text-white/90 hover:bg-white/20 hover:text-white",
          ...
          >
            <Card
              className={cn(
                ...
                variant === "glass" && "bg-white/10 border-white/20 text-white hover:bg-white/15",
              ...
              <CardContent className="p-4 flex items-start gap-3 h-full">
                {act.icon && (
                  <div className={cn(
                    ...
                    variant === "glass" ? "bg-white/10 text-white" : "bg-neutral-100 dark:bg-neutral-800 text-indigo-500 dark:text-indigo-400"
                  )}>
                    {act.icon}
                  </div>
                )}
...
| :--- | :--- | :--- | :--- |
| `actions` | `SuggestedAction[]` | `[]` | **(Required)** Suggested prompts mapping objects containing label, actionText, descriptions, and custom icons. |
...
| `animate` | `boolean` | `true` | Enables/Disables staggered spring entrance motion. |
